...
//$redirect = "https://enqddb.sweetmlif.net/c/da57dc555e50572d?s1=147078&s2=1367492&s3=lyovius1&click_id=freaky.fred0_4me&j1=1";
//$exit_link = "https://enqddb.sweetmlif.net/c/da57dc555e50572d?s1=147078&s2=1367492&s3=lyovius1&click_id=freaky.fred0_4me&j1=1";
...
switch ($countryCode) {
    ...
    case 'CY':
        ...
        break;
    case 'FI':
        $text = 'Flirttaile TikTok-tyttöjen kanssa'; $btn = 'LIITY ILMAISEKSI';
        break;
    case 'SE':
        $text = 'Flirta med TikTok-tjejer'; $btn = 'GÅ MED GRATIS';
        break;
    case 'LV':
        $text = 'Flirts ar TikTok meitenēm'; $btn = 'PIEVIENOTIES BEZ MAKSAS';
        break;
    case 'EE':
        $text = 'Flirtige TikToki tüdrukutega'; $btn = 'LIITU TASUTA';
        break;
    case 'NO':
        $text = 'Flørt med TikTok-jenter'; $btn = 'BLI MED GRATIS';
        break;
    case 'IL':
        $text = 'לפלרטט עם בנות TikTok'; $btn = 'הצטרף בחינם';
        break;
    case 'SI':
        $text = 'Spogledujte se z dekleti TikTok'; $btn = 'PRIDRUŽITE SE BREZPLAČNO';
        break;
    case 'BG':
        $text = 'Флиртувайте с момичета от TikTok'; $btn = 'ПРИСЪЕДИНИ СЕ БЕЗПЛАТНО';
        break;
    case 'JP':
        $text = 'TikTokの女の子と浮気'; $btn = '無料で参加';
        break;
    case 'KP':
    case 'KR':
        $text = 'TikTok 소녀들과 바람둥이'; $btn = '무료 가입';
        break;
    case 'PT':
        $text = 'Flerte com garotas TikTok'; $btn = 'PARTICIPE DE GRAÇA';
        break;
    case 'AE':
        $text = 'غازل فتيات TikTok'; $btn = 'انضم مجانا';
        break;
    case 'HR':
        $text = 'Koketirajte s TikTok djevojkama'; $btn = 'SLOBODNO SE PRIDRUŽI';
        break;
/*    case 'MY':
...
<main class="wrapper background-backgroundcolor">
    <section class="section">
        ...
        <div class="call-to-action">
            <section class="button-section"> <a class="btn" data-type="colusion" href="#" onclick="return execSML1()"><?= $btn ?></a>
            </section>
        </div>
